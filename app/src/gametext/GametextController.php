...
namespace touchdownstars\gametext {
    ...
    class GametextController
    {
        ...
        {
            $playerName = $player->getFirstName() . ' GametextController.php' . $player->getLastName();
            ...
            if (null != $tacklingPlayer) {
                $playerName = $tacklingPlayer->getFirstName() . ' GametextController.php' . $tacklingPlayer->getLastName();
            ...
            if (null != $quarterback) {
                $playerName = $quarterback->getFirstName() . ' GametextController.php' . $quarterback->getLastName();
